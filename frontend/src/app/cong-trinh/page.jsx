        ...
        <main className="container mx-auto py-10 px-4">
            ...
            <section className="mb-10">
                <p className="text-lg text-gray-700 mb-4 text-center">
                    Chúng tôi tự hào chia sẻ những công trình rèm cửa đã thi công thực tế. Dưới đây là một số hình ảnh
                    hoàn thiện và trải nghiệm thực tế từ đội ngũ Curtain Shop.
                </p>
            ...
            <section className="mb-10">
                ...
                <div className="bg-gray-50 p-4 rounded shadow text-gray-700 max-w-xl mx-auto">
                    <p className="italic">"Rèm cửa được lắp rất nhanh, đẹp và đúng ý tôi. Đội ngũ thi công chuyên
                        nghiệp, tư vấn tận tình. Tôi rất hài lòng!"</p>
                    <div className="text-right mt-2 font-semibold text-indigo-700">- Chị Lan, Quận 7</div>
                </div>
            </section>
            <div className="mt-10 text-center text-gray-500 text-sm">
                <p>Mọi thắc mắc về quy trình hoặc muốn xem mẫu thực tế, vui lòng liên hệ hotline hoặc điền vào form liên
                    hệ của chúng tôi!</p>
            </div>
        </main>
    );
