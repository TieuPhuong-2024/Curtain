...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8">Câu chuyện về Curtain Shop và những giá trị chúng tôi mang lại</p>
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-8">
              ...
              <p className="text-gray-600 mb-4">
                Curtain Shop được thành lập vào năm 2010 với niềm đam mê mang đến những sản phẩm rèm cửa 
                chất lượng cao và dịch vụ tốt nhất cho khách hàng. Chúng tôi bắt đầu từ một cửa hàng nhỏ 
                và hiện nay đã phát triển thành một trong những thương hiệu uy tín hàng đầu trong lĩnh vực 
                rèm cửa và trang trí nội thất.
              </p>
              <p className="text-gray-600">
                Với hơn 10 năm kinh nghiệm, chúng tôi tự hào đã phục vụ hơn 10,000 khách hàng hài lòng 
                trên khắp cả nước. Từ các căn hộ nhỏ đến biệt thự, văn phòng và khách sạn, sản phẩm của 
                chúng tôi đã góp phần tạo nên những không gian sống và làm việc đẹp đẽ, tiện nghi.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-center">
              Chúng tôi cam kết sử dụng những nguyên vật liệu tốt nhất và quy trình sản xuất tiên tiến 
              để tạo ra các sản phẩm bền đẹp, an toàn và thân thiện với môi trường.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-center">
              Chúng tôi đặt khách hàng vào trung tâm của mọi hoạt động. Từ tư vấn chọn lựa đến lắp đặt 
              và hậu mãi, chúng tôi luôn nỗ lực mang đến trải nghiệm tốt nhất cho khách hàng.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-center">
              Chúng tôi không ngừng đổi mới, cập nhật xu hướng và công nghệ mới nhất để mang đến những 
              sản phẩm độc đáo, thẩm mỹ và đáp ứng nhu cầu ngày càng cao của khách hàng.
            </p>
          </div>
        </div>
      </section>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Chúng tôi cung cấp đầy đủ các loại rèm cửa từ rèm vải, rèm cuốn, rèm sáo đến rèm cầu vồng 
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Chúng tôi cam kết mang đến sản phẩm chất lượng với mức giá hợp lý nhất trên thị trường.
                    </p>
                  </div>
                </li>
              </ul>
